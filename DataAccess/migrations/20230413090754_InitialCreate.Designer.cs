...
namespace Assignment.DataAccess.migrations
{
    ...
    [Migration("20230413090754_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment.DataAccess.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Assignment.Models.Order", b =>
                {
                    b.HasOne("Assignment.DataAccess.AppUser", "User")
                        .WithMany("Order")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Assignment.DataAccess.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
